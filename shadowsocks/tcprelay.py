...
from shadowsocks.common import parse_header, parse_header_v4, composite_connect_header
...
class TCPRelayHandler(object):
    ...
    def _handle_stage_addr(self, data, socks_v4 = False):
        try:
            if self._is_local:
                ...
                if cmd == CMD_UDP_ASSOCIATE:
                    ...
                    data = data[3:] if not socks_v4 else data[2:]
                else:
                    logging.error('unknown command %d', cmd)
                    self.destroy()
                    return
            header_result = parse_header(data) if not socks_v4 else parse_header_v4(data) # add socks v4
    ...
    def _on_local_read(self):
        ...
        if self._stage == STAGE_STREAM:
            ...
            if version == 4:
                ...
                self._handle_stage_addr(data, True)
                return
            elif version == 5:
